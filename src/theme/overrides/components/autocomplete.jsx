    ...
    MuiAutocomplete: {
      ...
      styleOverrides: {
        ...
        paper: {
          ...
          boxShadow: '0 0 1px 1px rgba(171, 171, 171, 0.24),0px 0px 0px 0px rgba(171, 171, 171, 0.24) !important'
        },
        listbox: {
          padding: 0,
          maxHeight: 200,
          ...
          // ✅ Firefox scrollbar
          scrollbarWidth: "thin",
          scrollbarColor: "#fffbfb23 transparent",
          ...
          "&::-webkit-scrollbar-thumb": {
            backgroundColor: "#fffbfb23 transparent",
            borderRadius: "4px",
          },
          "&::-webkit-scrollbar-thumb:hover": {
            backgroundColor: "#fffbfb23", // No change on hover
          },
